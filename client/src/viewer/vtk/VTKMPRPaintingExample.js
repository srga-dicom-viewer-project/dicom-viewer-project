...
class VTKMPRPaintingExample extends Component {
  ...
  componentDidMount() {
    ...
    const reader = vtkHttpDataSetReader.newInstance({
      fetchGzip: true,
      baseURL: 'https://react-vtkjs-viewport.netlify.app/',
    });
    ...
    reader.setUrl('http://localhost:5000/headsq.vti', { loadData: true }).then(() => {
  ...
  rerenderAllViewports = () => {
    ...
    Object.keys(this.apis).forEach(viewportIndex => {
      ...
      console.log(`Rerendering viewport ${viewportIndex}`);

      console.log(this.state.volumeRenderingVolumes)
      ...
      <div className="row">
        <div className="col-xs-12">
          ...
          <p>
            ...
            to interact wih the labelmap externally from the components, e.g.
        ...
        <button className="btn btn-danger" onClick={this.rerenderAllViewports}>
          rerenderAllViewports
        </button>
        {/* <div className="col-xs-12">
          <label>
